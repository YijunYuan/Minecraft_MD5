...
void inline display_result() {
	...
	for (int i = 0; i < 32; i++) {
		ofs << R"(execute if score md5.char)" << i << R"( result matches 0..0 run data merge entity @e[tag=char)"
			<< i << R"(,limit=1] {CustomName:"\"0\""})" << endl;
		ofs << R"(execute if score md5.char)" << i << R"( result matches 1..1 run data merge entity @e[tag=char)"
			<< i << R"(,limit=1] {CustomName:"\"1\""})" << endl;
		ofs << R"(execute if score md5.char)" << i << R"( result matches 2..2 run data merge entity @e[tag=char)"
			<< i << R"(,limit=1] {CustomName:"\"2\""})" << endl;
		ofs << R"(execute if score md5.char)" << i << R"( result matches 3..3 run data merge entity @e[tag=char)"
			<< i << R"(,limit=1] {CustomName:"\"3\""})" << endl;
		ofs << R"(execute if score md5.char)" << i << R"( result matches 4..4 run data merge entity @e[tag=char)"
			<< i << R"(,limit=1] {CustomName:"\"4\""})" << endl;
		ofs << R"(execute if score md5.char)" << i << R"( result matches 5..5 run data merge entity @e[tag=char)"
			<< i << R"(,limit=1] {CustomName:"\"5\""})" << endl;
		ofs << R"(execute if score md5.char)" << i << R"( result matches 6..6 run data merge entity @e[tag=char)"
			<< i << R"(,limit=1] {CustomName:"\"6\""})" << endl;
		ofs << R"(execute if score md5.char)" << i << R"( result matches 7..7 run data merge entity @e[tag=char)"
			<< i << R"(,limit=1] {CustomName:"\"7\""})" << endl;
		ofs << R"(execute if score md5.char)" << i << R"( result matches 8..8 run data merge entity @e[tag=char)"
			<< i << R"(,limit=1] {CustomName:"\"8\""})" << endl;
		ofs << R"(execute if score md5.char)" << i << R"( result matches 9..9 run data merge entity @e[tag=char)"
			<< i << R"(,limit=1] {CustomName:"\"9\""})" << endl;
		ofs << R"(execute if score md5.char)" << i << R"( result matches 10..10 run data merge entity @e[tag=char)"
			<< i << R"(,limit=1] {CustomName:"\"A\""})" << endl;
		ofs << R"(execute if score md5.char)" << i << R"( result matches 11..11 run data merge entity @e[tag=char)"
			<< i << R"(,limit=1] {CustomName:"\"B\""})" << endl;
		ofs << R"(execute if score md5.char)" << i << R"( result matches 12..12 run data merge entity @e[tag=char)"
			<< i << R"(,limit=1] {CustomName:"\"C\""})" << endl;
		ofs << R"(execute if score md5.char)" << i << R"( result matches 13..13 run data merge entity @e[tag=char)"
			<< i << R"(,limit=1] {CustomName:"\"D\""})" << endl;
		ofs << R"(execute if score md5.char)" << i << R"( result matches 14..14 run data merge entity @e[tag=char)"
			<< i << R"(,limit=1] {CustomName:"\"E\""})" << endl;
		ofs << R"(execute if score md5.char)" << i << R"( result matches 15..15 run data merge entity @e[tag=char)"
